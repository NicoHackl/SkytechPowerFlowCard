...
// Log Version
console.groupCollapsed(`%c⚡ Skytech Power Flow Card v${version} is installed`, "color: #488fc2; font-weight: bold");
console.log("Readme:", "https://github.com/NicoHackl/SkytechPowerFlowCard");
console.groupEnd();
