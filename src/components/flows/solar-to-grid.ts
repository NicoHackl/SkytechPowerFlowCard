...
const solarToGridDot = (config: SkytechPowerFlowCardConfig, solar: Flows["solar"], newDur: Flows["newDur"]) => {
...
export const flowSolarToGrid = (config: SkytechPowerFlowCardConfig, { battery, grid, individual, solar, newDur }: Flows) => {
